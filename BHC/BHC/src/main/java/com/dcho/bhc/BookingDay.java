 ...
 * 
 * @author evansrb1
 * @version 1.1 Updated methods for setting seasons
 * @version 1.2 Added copyright notice
 */
...
//        System.out.println("getDate(" + year + "," + month + "," + dayOfMonth + "0");
	...
	// This is a quick and dirty method to get the number of days in a month,
	// taking into consideration leap years as well.
	public static int numberOfDaysInMonth(int year, int month) {
		if(month < 1 || month > 12) {
			throw new IllegalArgumentException("Month must be 1-12");
		}
		if(year < 1900 || year > 2500) {
			throw new IllegalArgumentException("Year must be 1900-2500");
		}
		switch (month) {
		// 31 days in Jan, Mar, May, July, August, October, December
		case 1:
		case 3:
		case 5:
		case 7:
